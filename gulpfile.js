...
exports.less = function () {
    // цепочка вызовов
    return gulp.src('./src/styles/*.less') // Используем объект gulp и вызываем у него функцию src, этой функцией мы указываем что там находятся исходники файлов с которыми будем работать
        .pipe(less())
